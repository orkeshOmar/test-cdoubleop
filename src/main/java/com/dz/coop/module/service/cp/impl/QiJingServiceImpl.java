 ...
 */
@Service
public class QiJingServiceImpl implements ClientService {
    private static final Logger logger = LoggerFactory.getLogger(QiJingServiceImpl.class);
        ...
        try {
            ...
            if ("0".equals(code)) {
                ...
                for (Object obj : jsonArray.toArray()) {
                    ...
                    bookList.add(new CPBook(map.get("id")+"",(String) map.get("name")));
                }
            }else{
    ...
    public CPBook getBookInfo(Partner owchPartner, String bookId) throws Exception {
        ...
        try {
            ...
            if ("0".equals(code)) {
                ...
                cpBook.setName((String)map.get("name"));
                cpBook.setCover((String)map.get("cover"));
                cpBook.setAuthor((String)map.get("author"));
                cpBook.setCompleteStatus(map.get("isFinish")+"");
                cpBook.setBrief((String)map.get("about"));
            }else{
                throw new Exception("通信异常，error code : " + code +" , error msg : " + object.getString("error"));
            }
            return cpBook;
